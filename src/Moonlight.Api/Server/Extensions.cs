...
namespace Moonlight.Api.Server
{
    public static class Extensions
    {
        /// <summary>
        /// Serializes an object to JSON, using <see cref="System.Text.Json"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="value">An int, long or string. Arrays of the previously mentioned types are supported.</param>
        /// <returns>The variable length of the object.</returns>
        public static int GetVarLength(this object value)
        {
            ...
            switch (value)
            {
                ...
                default:
                    throw new ArgumentException($"Invalid type: {value.GetType()}. Expected int, long, string or their array variants.", nameof(value));
            }
        }
